...
% Replace with:
with the Rydberg constant now derived from first principles rather
than fitted empirically---a numerical agreement so precise it left
no doubt that the quantisation condition was capturing something
real, even without ontological justification.
...
\TODO{added, afinar: Consider a paragraph on effective field theory (Weinberg, Wilson): EFT explicitly embraces ontological incompleteness at each scale. That may be a more honest framing than ``the problem is unsolved.''}

This situation is perhaps better understood through the lens of
effective field theory \cite{weinberg_1979_eft}: rather than
a deficiency awaiting resolution, ontological incompleteness at
each energy scale is a permanent structural feature of physical
theorising. Each theory carries a partial ontology adequate to its
domain; what lies beyond is encoded in the theory's own breakdown,
not in a completed picture waiting to be found.