...
Newton's \textit{Principia Mathematica} \cite{newton_1687_principia} establishes that for uniform circular motion of radius $r$ and speed $v$, differentiating the position vector $\vec{r}(t) = r(\cos\omega t,\,\sin\omega t)$ twice with $\omega = v/r$ gives
\begin{equation}
